/**
 * Await selector
 * promise for detecting when element is added to DOM using mutation observer or interval fallback
 * @param selector
 * @param rootNode
 * @param fallbackDelay
 * @returns {Promise<unknown>}
 */
const awaitSelector = (selector, rootNode, fallbackDelay) =>
...
/**
 * Watch await selector
 * watch and detect when element is dynamically added to DOM
 * @param callback
 * @param selector
 * @param rootNode
 * @param fallbackDelay
